...
<center>
<a>회원가입</a>
<form method="POST" action="registerPro.sku" onsubmit="return result();">
	<table>
		<tr>
			<td class="text">이름</td>
			<td><input type="text" name="name" placeholer="이름"></td>
		</tr>
		<tr>
			<td class="text">아이디</td>
			<td><input type="text" name="id" id="input_id" onkeydown="return showKeyCode(event)" maxLength="10">&nbsp;<input type="button" value="중복확인" onclick="id_confirm()">
