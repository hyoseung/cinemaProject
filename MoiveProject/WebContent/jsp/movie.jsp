...
<center>
	...
	<table id="movieList_table">
		...
		<span class="main-viewlist">
			...
			<div id="btn_title">
				<span class="detail-movie" id="<%=list.get(i).getCode()%>" value="<%=list.get(i).getType()%>" onclick="detail_movie(this)">상세정보</span>
				<span class="reserve-movie" id="<%=list.get(i).getCode()%>" value="<%=list.get(i).getType()%>" onclick="detail_reserve(this)">
				예매하기
				</span>				
			</div>
		</span>
